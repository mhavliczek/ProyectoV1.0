...
if df.empty:
    ...
    ax.set_ylim(0, df_agrupado["Viscosidad 100°C cSt(mm2/s)"].max() * 1.2)  # Limitar el eje Y
    ...
    ax.set_title("Proporción de Niveles de Criticidad", fontsize=14, color="#003366")
    st.pyplot(fig)
    ...
    ax.set_title("Comparación de TAN y TBN", fontsize=14, color="#003366")
    ax.set_xlabel("TAN (mg KOH/g)", fontsize=12)
    ax.set_ylabel("TBN (mg KOH/g)", fontsize=12)
    ax.grid(True, linestyle="--", alpha=0.5)
    st.pyplot(fig)
    ...
    ax.set_title("Distribución del Contenido de Agua", fontsize=14, color="#003366")
    ax.set_xlabel("Componente", fontsize=12)
    ax.set_ylabel("Contenido de Agua (%)", fontsize=12)
    ax.grid(True, linestyle="--", alpha=0.5)
    st.pyplot(fig)